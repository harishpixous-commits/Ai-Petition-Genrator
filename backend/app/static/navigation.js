...
const NAV = {
  en: {
    ...
    homeEyebrow: "CITIZEN PETITION WORKSPACE", homeTitle: "Your voice. Put into action.",
    homeDescription: "Prepare a petition, keep your documents together, and make changes whenever you need to.",
    createDescription: "Tell us your concern by chat or voice. Review your details and generate a document.",
    petitionsDescription: "Find saved petitions, continue editing, and download the latest version.",
    homeNote: "Available in English and Tamil. You review every petition before submitting it yourself.",
    petitionsEyebrow: "YOUR SAVED WORK", petitionsTitle: "My Petitions",
    petitionsDescriptionLong: "Find a petition, make a change, or download the latest saved document.",
  ...
  ta: {
    ...
    homeEyebrow: "குடிமகன் மனு பணியிடம்", homeTitle: "உங்கள் குரல். உங்கள் மனு.",
    homeDescription: "மனுவைத் தயாரிக்கவும், ஆவணங்களை இணைக்கவும், தேவையான மாற்றங்களைச் செய்யவும்.",
    createDescription: "தட்டச்சு அல்லது குரல் மூலம் குறையைப் பகிர்ந்து, விவரங்களைச் சரிபார்த்து மனுவைப் பெறுங்கள்.",
    petitionsDescription: "சேமித்த மனுக்களைத் தேடவும், திருத்தவும், புதிய பதிப்பைப் பதிவிறக்கவும்.",
    homeNote: "தமிழ் மற்றும் ஆங்கிலத்தில் கிடைக்கிறது. சமர்ப்பிக்கும் முன் ஒவ்வொரு மனுவையும் சரிபார்க்கவும்.",
    petitionsEyebrow: "சேமித்த மனுக்கள்", petitionsTitle: "எனது மனுக்கள்",
    petitionsDescriptionLong: "மனுவைக் கண்டறிந்து திருத்தவும் அல்லது சமீபத்திய ஆவணத்தைப் பதிவிறக்கவும்.",
